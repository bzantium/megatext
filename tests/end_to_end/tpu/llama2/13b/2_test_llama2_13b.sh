...
# Please make sure you have run tests/end_to_end/tpu/llama2/13b/1_test_llama2_13b.sh before running commands from this file. 

# The flow of this file is as follows:
# 1. Run decoding, finetuning of Llama2-13B with the converted checkpoint obtained from tests/end_to_end/tpu/llama2/13b/1_test_llama2_13b.sh. Also, run pretraining of Llama2-13B
# 2. Run more efficient decoding with the unscanned checkpoint obtained from tests/end_to_end/tpu/llama2/13b/1_test_llama2_13b.sh.
# 3. Run decoding from the finetuned checkpoint from step 1


# Example Usage: export BASE_OUTPUT_PATH=/path/to/GCS/bucket; bash tests/end_to_end/tpu/llama2/13b/2_test_llama2_13b.sh
# Use the same BASE_OUTPUT_PATH as tests/end_to_end/tpu/llama2/13b/1_test_llama2_13b.sh
