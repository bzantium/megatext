...
# Please make sure you have run tests/end_to_end/tpu/gemma2/9b/1_test_gemma.sh before running commands from this file. 

# The flow of this file is as follows:
# 1. Run decoding, finetuning of Gemma2 9b with the converted checkpoint obtained from tests/end_to_end/tpu/gemma2/9b/1_test_gemma.sh. Also, run pretraining of Gemma2 9b
...
# Use the same BASE_OUTPUT_PATH as tests/end_to_end/tpu/gemma2/9b/1_test_gemma.sh
