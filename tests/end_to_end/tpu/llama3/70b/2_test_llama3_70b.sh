...
# Please make sure you have run tests/end_to_end/tpu/llama3/70b/1_test_llama3_70b.sh before running commands from this file. 

# The flow of this file is as follows:
# 1. Run decoding, finetuning of Llama3-70B with the converted checkpoint obtained from tests/end_to_end/tpu/llama3/70b/1_test_llama3_70b.sh. Also, run pretraining of Llama3-70B
...
# Example Usage: export BASE_OUTPUT_PATH=/path/to/GCS/bucket; bash tests/end_to_end/tpu/llama3/70b/2_test_llama3_70b.sh
# Use the same BASE_OUTPUT_PATH as tests/end_to_end/tpu/llama3/70b/1_test_llama3_70b.sh
