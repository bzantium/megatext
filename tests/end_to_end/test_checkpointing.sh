...
CMD1="python3 -m maxtext.trainers.pre_train.train ${MAXTEXT_CONFIGS_DIR:-${MAXTEXT_REPO_ROOT:-$PWD}/src/maxtext/configs}/base.yaml run_name=$RUN_NAME steps=5 max_target_length=128 per_device_batch_size=1\
...
CMD2="python3 -m maxtext.trainers.pre_train.train ${MAXTEXT_CONFIGS_DIR:-${MAXTEXT_REPO_ROOT:-$PWD}/src/maxtext/configs}/base.yaml run_name=$RUN_NAME steps=10 max_target_length=128 per_device_batch_size=1\
