...
from megatext.utils.sharding import _ACTIVATION_SHARDINGS_DUMP
...
def main(argv: Sequence[str]) -> None:
  ...
  base_path = Path(
      f"{MAXTEXT_REPO_ROOT}/tests/utils/sharding_info/{config.model}/"
  ...
  print(f"Finished: {config.model} {config.compile_topology}")
