"""Gemma3 model_type: mapping + transforms."""
...
from megatext.conversion.utils import (
    ...
    _build_rmsnorm_transforms, _cfg, _global_keys, _layer_mapping,
    _make_logits_transform,
)
...
def build_gemma3(arch: ArchSpec, hf_config: Any, scan_layers: bool) -> Mapping:
    cfg = _cfg(hf_config)
...
def build_gemma3_transforms(
    ...
    transforms.update(_build_rmsnorm_transforms(arch, to_hf, [
