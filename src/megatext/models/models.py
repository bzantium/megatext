...
from megatext.common.common_types import Config, DECODING_ACTIVE_SEQUENCE_INDICATOR, MODEL_MODE_AUTOREGRESSIVE, MODEL_MODE_TRAIN
...
from megatext.layers.embeddings import Embed, embed_as_linen
from megatext.layers.encoders import AudioEncoder, VisionEncoder, audio_encoder_as_linen, vision_encoder_as_linen
...
class TransformerLinenPure(nn.Module):
  ...
  mesh: Mesh
  quant: Quant
  # Possible model_mode values can be found in megatext.common.common_types.
  # We generally use megatext.common.common_types.MODEL_MODE_TRAIN or
  # megatext.common.common_types.MODEL_MODE_PREFILL for initializations here.
