...
1.  **Parameter Name Mappings (`PARAM_MAPPING`)**: Dictionaries that map a MaxText
    ...
    generated by functions like `GEMMA2_MEGATEXT_TO_HF_PARAM_MAPPING`.
...
2.  **Hook Functions (`HOOK_FNS`)**: Dictionaries that map a MaxText parameter
    ...
    `GEMMA2_MEGATEXT_TO_HF_PARAM_HOOK_FN`.
...
def GEMMA3_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
...
def GEMMA3_MEGATEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
...
def GEMMA2_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
...
def GEMMA2_MEGATEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
...
def QWEN_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
...
def QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
...
def QWEN3_NEXT_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
  """
...
def QWEN3_NEXT_MEGATEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
  """
...
def DEEPSEEK_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
...
def DEEPSEEK_MEGATEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
...
def GPT_OSS_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
...
def QWEN3_OMNI_MOE_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
  ...
  text_mapping = QWEN_MEGATEXT_TO_HF_PARAM_MAPPING(
...
def QWEN3_OMNI_MOE_MEGATEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
  ...
  num_experts_text = config["thinker_config"]["text_config"].get("num_experts", 0)
  n_layers_text = config["thinker_config"]["text_config"]["num_hidden_layers"]
  text_hooks = QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN(
      config={"num_hidden_layers": n_layers_text, "num_experts": num_experts_text},
      maxtext_config=maxtext_config,
      scan_layers=scan_layers,
...
def LLAMA31_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
  """
...
def LLAMA31_MEGATEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
...
def MIXTRAL_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
  """
...
def MIXTRAL_MEGATEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
  """
...
def OLMO3_MEGATEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
...
def OLMO3_MEGATEXT_TO_HF_PARAM_HOOK_FN(config, maxtext_config, scan_layers=False, saving_to_hf=False):
...
PARAM_MAPPING = {
    "gemma2-2b": GEMMA2_MEGATEXT_TO_HF_PARAM_MAPPING,
    "gemma2-9b": GEMMA2_MEGATEXT_TO_HF_PARAM_MAPPING,
    "gemma2-27b": GEMMA2_MEGATEXT_TO_HF_PARAM_MAPPING,
    "gemma3-4b": GEMMA3_MEGATEXT_TO_HF_PARAM_MAPPING,
    "gemma3-12b": GEMMA3_MEGATEXT_TO_HF_PARAM_MAPPING,
    "gemma3-27b": GEMMA3_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen2.5-1.5b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen2.5-7b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen2.5-14b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-0.6b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-1.7b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-1.7b-base": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-4b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-4b-base": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-4b-thinking-2507": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-8b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-8b-base": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-14b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-14b-base": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-32b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "llama3.1-8b": LLAMA31_MEGATEXT_TO_HF_PARAM_MAPPING,
    "llama3.1-70b": LLAMA31_MEGATEXT_TO_HF_PARAM_MAPPING,
    "llama3.1-405b": LLAMA31_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-30b-a3b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-30b-a3b-base": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-235b-a22b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-coder-480b-a35b": QWEN_MEGATEXT_TO_HF_PARAM_MAPPING,
    "deepseek2-16b": DEEPSEEK_MEGATEXT_TO_HF_PARAM_MAPPING,
    "deepseek3-671b": DEEPSEEK_MEGATEXT_TO_HF_PARAM_MAPPING,
    "deepseek3.2-671b": DEEPSEEK_MEGATEXT_TO_HF_PARAM_MAPPING,
    "gpt-oss-20b": GPT_OSS_MEGATEXT_TO_HF_PARAM_MAPPING,
    "gpt-oss-120b": GPT_OSS_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-omni-30b-a3b": QWEN3_OMNI_MOE_MEGATEXT_TO_HF_PARAM_MAPPING,
    "qwen3-next-80b-a3b": QWEN3_NEXT_MEGATEXT_TO_HF_PARAM_MAPPING,
    "mixtral-8x7b": MIXTRAL_MEGATEXT_TO_HF_PARAM_MAPPING,
    "mixtral-8x22b": MIXTRAL_MEGATEXT_TO_HF_PARAM_MAPPING,
    "olmo3-7b": OLMO3_MEGATEXT_TO_HF_PARAM_MAPPING,
    "olmo3-7b-pt": OLMO3_MEGATEXT_TO_HF_PARAM_MAPPING,
    "olmo3-32b": OLMO3_MEGATEXT_TO_HF_PARAM_MAPPING,
}

# {maxtext model name: {maxtext weight name: bi-directional transform}}
HOOK_FNS = {
    "gemma2-2b": GEMMA2_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "gemma2-9b": GEMMA2_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "gemma2-27b": GEMMA2_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "gemma3-4b": GEMMA3_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "gemma3-12b": GEMMA3_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "gemma3-27b": GEMMA3_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen2.5-1.5b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen2.5-7b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen2.5-14b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-0.6b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-1.7b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-1.7b-base": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-4b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-4b-base": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-4b-thinking-2507": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-8b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-8b-base": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-14b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-14b-base": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-32b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "llama3.1-8b": LLAMA31_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "llama3.1-70b": LLAMA31_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "llama3.1-405b": LLAMA31_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-30b-a3b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-30b-a3b-base": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-235b-a22b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-coder-480b-a35b": QWEN_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "deepseek2-16b": DEEPSEEK_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "deepseek3-671b": DEEPSEEK_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "deepseek3.2-671b": DEEPSEEK_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "gpt-oss-20b": GPT_OSS_TO_HF_PARAM_HOOK_FN,
    "gpt-oss-120b": GPT_OSS_TO_HF_PARAM_HOOK_FN,
    "qwen3-omni-30b-a3b": QWEN3_OMNI_MOE_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "qwen3-next-80b-a3b": QWEN3_NEXT_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "mixtral-8x7b": MIXTRAL_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "mixtral-8x22b": MIXTRAL_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "olmo3-7b": OLMO3_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "olmo3-7b-pt": OLMO3_MEGATEXT_TO_HF_PARAM_HOOK_FN,
    "olmo3-32b": OLMO3_MEGATEXT_TO_HF_PARAM_HOOK_FN,
}
