...
python3 -m megatext.checkpoint_conversion.standalone_scripts.convert_qwen3_next_unscanned \
...
from megatext.checkpoint_conversion.standalone_scripts.convert_qwen3_next_scanned import MODEL_PARAMS_DICT
