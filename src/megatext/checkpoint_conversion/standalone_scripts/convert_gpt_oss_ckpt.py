...
python3 -m megatext.checkpoint_conversion.standalone_scripts.convert_gpt_oss_ckpt --base-model-path <path/to/hf/ckpt> \
...
from megatext.checkpoint_conversion.standalone_scripts.convert_gpt_oss_unscanned_ckpt import MODEL_PARAMS_DICT, _hf_to_maxtext_mapping, _pt_to_np
from megatext.checkpoint_conversion.utils.utils import MemoryMonitorTqdm, print_peak_memory
