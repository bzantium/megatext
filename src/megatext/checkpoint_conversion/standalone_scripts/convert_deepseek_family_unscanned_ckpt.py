...
python3 -m megatext.checkpoint_conversion.standalone_scripts.convert_deepseek_family_unscanned_ckpt \
...
from megatext.checkpoint_conversion.standalone_scripts import convert_deepseek_family_ckpt as ds_ckpt
