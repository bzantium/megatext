...
def workload_monitor():
  ...
  def _import():
    from megatext.common.gcp_workload_monitor import GCPWorkloadMonitor  # type: ignore  # pylint: disable=import-outside-toplevel
...
def vertex_tensorboard_modules():
  ...
  def _import():
    from megatext.common.vertex_tensorboard import VertexTensorboardManager  # type: ignore  # pylint: disable=import-outside-toplevel
