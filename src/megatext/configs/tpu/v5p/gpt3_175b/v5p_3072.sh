...
# bash src/maxtext/configs/tpu/v5p/gpt3_175b/v5p_3072.sh YOUR_RUN gs://YOUR_BUCKET"
...
./maxtext/configs/tpu/v5p/gpt3_175b/gpt3_175b_base.sh 2 "save_dot_except_mlpwi" 12 16 8 "${RUNNAME}" "${BASE_OUTPUT_DIRECTORY}" 