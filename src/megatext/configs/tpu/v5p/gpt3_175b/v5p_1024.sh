...
# bash src/maxtext/configs/tpu/v5p/gpt3_175b/v5p_1024.sh YOUR_RUN gs://YOUR_BUCKET"
...
./maxtext/configs/tpu/v5p/gpt3_175b/gpt3_175b_base.sh 4 "full" 1 64 8 "${RUNNAME}" "${BASE_OUTPUT_DIRECTORY}"
